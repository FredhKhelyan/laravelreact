...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      alert("Informations non enregistrées");
    }
  };
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                id="fullName"
                className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 text-blue-600"
